...
const autocompleteUI = ({ options = {} }) => {
    ...
    const fetchResults = (0, react_1.useCallback)((searchQuery) => __awaiter(void 0, void 0, void 0, function* () {
        if (searchQuery.length < config.threshold)
            return;
    ...
    const renderFooter = () => {
        if (results.length === 0)
            return null;
        return (react_1.default.createElement(react_native_1.View, { style: styles.footerContainer },
            react_1.default.createElement(react_native_1.View, { style: { flexDirection: "row", alignItems: "center" } },
                react_1.default.createElement(react_native_1.Text, { style: styles.footerText }, "Powered by"),
                react_1.default.createElement(react_native_1.Image, { source: images_1.RADAR_LOGO, resizeMode: "contain", style: styles_1.default.logo }))));
    };
    const renderItem = ({ item }) => {
        ...
        return (react_1.default.createElement(react_native_1.Pressable, { style: ({ pressed }) => [
            ...
            react_1.default.createElement(react_native_1.View, { style: styles.addressContainer },
                react_1.default.createElement(react_native_1.View, { style: styles.pinIconContainer }, config.showMarkers ? (react_1.default.createElement(react_native_1.Image, { source: images_1.MARKER_ICON, style: styles.pinIcon })) : null),
                react_1.default.createElement(react_native_1.View, { style: styles.addressTextContainer },
                    react_1.default.createElement(react_native_1.Text, { numberOfLines: 1, style: styles.addressText }, item.addressLabel || (item === null || item === void 0 ? void 0 : item.placeLabel)),
                    (item === null || item === void 0 ? void 0 : item.formattedAddress.length) > 0 && (react_1.default.createElement(react_native_1.Text, { numberOfLines: 1, style: styles.addressSubtext }, (_a = item === null || item === void 0 ? void 0 : item.formattedAddress) === null || _a === void 0 ? void 0 : _a.replace(`${(item === null || item === void 0 ? void 0 : item.addressLabel) || (item === null || item === void 0 ? void 0 : item.placeLabel)}, `, "")))))));
    };
    ...
    return (react_1.default.createElement(react_native_1.View, { style: styles.container },
        react_1.default.createElement(react_native_1.Animated.View, { style: { height: inputHeight } },
            react_1.default.createElement(react_native_1.TouchableOpacity, { style: styles.inputContainer, onPress: () => {
                    if (config.disabled)
                        return;
                    setIsOpen(true);
                ...
                react_1.default.createElement(react_native_1.Image, { source: images_1.SEARCH_ICON, style: styles.inputIcon }),
                react_1.default.createElement(react_native_1.TextInput, { style: styles.input, onFocus: () => {
                        setIsOpen(true);
                        setTimeout(() => {
                            textInputRef.current.focus();
                        }, 100);
                    }, value: query, returnKeyType: "done", placeholder: config.placeholder, placeholderTextColor: "#acbdc8" }))),
        react_1.default.createElement(react_native_1.Modal, { animationType: "slide", transparent: false, visible: isOpen, onRequestClose: () => setIsOpen(false) },
            react_1.default.createElement(react_native_1.Animated.View, { style: { flex: 1, opacity: modalOpacity } },
                react_1.default.createElement(react_native_1.SafeAreaView, null,
                    react_1.default.createElement(react_native_1.KeyboardAvoidingView, { behavior: Platform.OS === "ios" ? "padding" : "height", keyboardVerticalOffset: 50, style: styles.container },
                        react_1.default.createElement(react_native_1.View, { style: styles.modalInputContainer },
                            react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: () => {
                                    setIsOpen(false);
                                } },
                                react_1.default.createElement(react_native_1.Image, { source: images_1.BACK_ICON, style: styles.inputIcon })),
                            react_1.default.createElement(react_native_1.TextInput, { ref: textInputRef, style: styles.input, onChangeText: handleInput, value: query, placeholder: config.placeholder, returnKeyType: "done", onSubmitEditing: () => {
                                    setIsOpen(false);
                                }, placeholderTextColor: "#acbdc8" }),
                            react_1.default.createElement(react_native_1.TouchableOpacity, { onPress: () => {
                                    setQuery("");
                                } },
                                react_1.default.createElement(react_native_1.Image, { source: images_1.CLOSE_ICON, style: styles.closeIcon }))),
                        results.length > 0 && (react_1.default.createElement(react_native_1.View, { style: styles.resultListWrapper },
                            react_1.default.createElement(react_native_1.FlatList, { style: styles.resultList, data: results, onScroll: () => {
